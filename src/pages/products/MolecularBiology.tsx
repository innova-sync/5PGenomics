        ...
        <div className="px-6 py-5 space-y-6">
          ...
          <div className="flex items-start gap-3 bg-blue-50 border border-blue-100 rounded-xl px-4 py-3">
            ...
            <p className="text-xs text-blue-600 leading-relaxed">
              Clicking <strong>"Send Quote Request"</strong> will open your email
              app with everything pre-filled and addressed to our team. Just press{" "}
              <strong>Send</strong> in your email app to submit.
            </p>
          </div>
  ...
  <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4">
    <div className="bg-white rounded-2xl shadow-2xl w-full max-w-sm text-center px-8 py-10">
      ...
      <p className="text-gray-500 text-sm mb-2 leading-relaxed">
        ...
        team. Just press{" "}
        <span className="font-semibold text-navy">Send</span> in your email app
        to complete it.
      </p>
      <p className="text-xs text-gray-400 mb-6">
        Expect a response within{" "}
        <span className="font-semibold text-navy">24–48 hours</span> once sent.
      </p>
      <button
        onClick={onClose}
