...
const products = [
  {
    ...
    img: "/src/assets/alco quant 6020 plus breathalyzer.jpg",
    category: ["cat1"],
  },
  {
    title: "DrugWipe 5 S",
    desc: "Detects slight traces of drugs using saliva.",
    img: "/src/assets/saliva drug test drugwipe 5 s.jpg",
    category: ["cat2"],
  },
  {
    title: "DrugWipe 6 S",
    desc: "Advanced saliva drug testing system.",
    img: "/src/assets/saliva drug test drugwipe 6 s.jpg",
    category: ["cat2"],
  },
  {
    title: "Urine Drug Test Cup",
    desc: "All-in-one multi-drug urine testing solution.",
    img: "/src/assets/drugwipe wipealyser.jpg",
    category: ["cat3"],
  },
  {
    title: "Hair Drug Test Device",
    desc: "Forensic toxicology hair testing solution.",
    img: "/src/assets/rapid chop-a-chop ghb-ket drink test.jpg",
    category: ["cat4"],
  },
  {
    title: "Surface Drug Test",
    desc: "Detect traces of drugs on surfaces.",
    img: "/src/assets/chop-a-chop urine multi-drug test cup.jpg",
    category: ["cat5"],
  },
  {
    title: "Vape Detector",
    desc: "Detect vaping in restricted environments.",
    img: "/src/assets/toxicology hair test.jpg",
    category: ["cat6"],
  },
  {
    title: "Aero Chamber Sniffer for Drugs and Explosives Detection",
    desc: "Detect vaping in restricted environments.",
    img: "/src/assets/aero chamber sniffer.jpg",
    category: ["cat6"],
  },
  {
    title: "Drug Surface test DrugWipe F",
    desc: "Detect vaping in restricted environments.",
    img: "/src/assets/drug surface test drugwipe f.jpg",
    category: ["cat6"],
  },
  {
    title: "Drug screening test DrugWipe A",
    desc: "Detect vaping in restricted environments.",
    img: "/src/assets/drug screening test drugwipe a.jpg",
    category: ["cat6"],
  },
  {
    title: "General Screening Drugs Detection and Identification",
    desc: "Detect vaping in restricted environments.",
    img: "/src/assets/general screening drugs detection and Identification.jpg",
    category: ["cat6"],
  },
  {
    title: "Etomidate (ETO) Rapid Oral Fluid Drug Test Kit",
    desc: "Detect vaping in restricted environments.",
    img: "/src/assets/Etomidate (ETO) Rapid Oral fluid Drug Test.jpg",
    category: ["cat6"],
  },
    {
    title: "Etomidate (ETO) Rapid Urine Drug Test Kit",
    desc: "Detect vaping in restricted environments.",
    img: "/src/assets/Etomidate (ETO) Rapid Urine Drug Test.jpg",
    category: ["cat6"],
  },
    {
    title: "DetekVape Wi-Fi Vape Detector Singapore",
    desc: "Detect vaping in restricted environments.",
    img: "/src/assets/DetekVape Wi-Fi Vape Detector thumbnail.jpg",
    category: ["cat6"],
  },
];
